...
class JackTokenizer:
    ...
    def __init__(self, file_name: Path):
        ...
        assert file_name.suffix == '.jack', 'the input file must be Xxx.jack'
        self.file_name = file_name.parent / file_name.stem
...
class JackAnalyzer:
    ...
    def __init__(self, input_file: Path):
        assert input_file.suffix == '.jack', 'the input file must be Xxx.jack'
        self.input_file = input_file
        self.file_name = input_file.stem
        self.output_file = input_file.parent / (self.file_name + '1.xml')
...
def main():
    # file = sys.argv[1]
    input_file = Path('chapter11_data/Seven/Main.jack')
    JackAnalyzer(input_file).analyze()
