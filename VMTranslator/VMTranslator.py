...
class VMTranslator:
    ...
    def __init__(self, file_path):
        ...
        if os.path.isdir(file_path):
            ...
            self.asm_filename = file_path.split("/")[-1] + ".asm"
...
def main():
    ...
    source_file_path = str(FUNCTION_CALLS_DATA_ROOT / file_name)
    vmtranslator = VMTranslator(source_file_path)
    vmtranslator.parse()
